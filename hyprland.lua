...
hl.on("hyprland.start", function () 
  hl.exec_cmd("systemctl start NetworkManager")
  hl.exec_cmd("systemctl start bluetooth & bluetoothctl power off")
  hl.exec_cmd("waybar & hyprpaper & brightnessctl set 0%")
  hl.exec_cmd(menu)
end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(00FF00ee)", "rgba(005500ee)"}, angle = 45 },
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 1.0, bezier = "easeInOutCubic", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 1.0, bezier = "easeInOutCubic", style = "slide" })
hl.animation({ leaf = "zoomFactor",    enabled = true,  speed = 7,    bezier = "quick" })
hl.animation({ leaf = "specialWorkspace",    enabled = true,  speed = 1.94, bezier = "quick", style = "fade" })
...
hl.bind(mainMod .. " + CTRL + SHIFT + Q", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(fileManager))
hl.bind(mainMod .. " + V", hl.dsp.window.float({ action = "toggle" }))
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(menu))
-- Bonne idée, mauvaise implémentation
-- hl.bind(mainMod .. " + ALT_L", hl.dsp.exec_cmd(menu))
-- hl.bind(mainMod .. " + ISO_Level3_Shift", hl.dsp.exec_cmd("rofi -show run"))
-- hl.bind("MOD5 + ALT_L", hl.dsp.exec_cmd("rofi -show filebrowser"))
-- hl.bind("MOD5 + ISO_Level3_Shift", hl.dsp.exec_cmd("rofi -show window"))
...
hl.bind(mainMod .. " + CTRL + SHIFT + P", hl.dsp.exec_cmd("hyprshutdown -t \"Goodbye!\" -p \"poweroff\""))
hl.bind(mainMod .. " + CTRL + SHIFT + R", hl.dsp.exec_cmd("hyprshutdown -t \"BRB!\" -p \"reboot\""))
...
hl.bind(mainMod .. " + SHIFT + SPACE",  hl.dsp.exec_cmd("playerctl next"),       { locked = true })
...
-- Makes satty come in floating mode
hl.window_rule({
    name  = "satty-floating-mode",
